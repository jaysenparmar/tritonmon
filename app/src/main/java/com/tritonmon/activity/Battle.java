...
public class Battle extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int pokemon2Level = BattleUtil.getRandomPokemonLevel(CurrentUser.getPokemonParty().getPokemon(selectedPokemonIndex).getLevel());

        // asdf
        pokemon2 = new BattlingPokemon(Pokemon.getPokemonId(BattleUtil.getRandomPokemonId(pokemon2Level)), pokemon2Level, true);
//        pokemon2 = new BattlingPokemon(Pokemon.getPokemonId("vileplume"), 30, true);
